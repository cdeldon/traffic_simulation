...
\label{eq:IDM}
\end{equation}
This equation contains two parts, the \emph{free road term}, and the \emph{interaction term}. For a low vehicle density (i.e. $s_\alpha \rightarrow 0$) \FIXME{Shouldn't it be $s_\alpha \gg 1$} the above equation can be simplified to
\begin{equation}
